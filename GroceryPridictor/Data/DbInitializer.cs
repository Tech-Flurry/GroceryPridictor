    ...
    public class DbInitializer
    {
        public static void Initialize(GroceryContext context)
        {
            ...
            new User{ UserName = "William" , Email = "william@gamil.com", Password= "1234" , Latitude="41234214" , Longitude ="3412341324", Phone="4234112" ,UserType ="Seller"},
                ...
                {
                new Product{ProductId=2,Catagory="Sanitary",Price=123,Stock=123,StoreId=1,UserId= 1,Discount="20",Link="https://www.daraz.pk/products/samsung-s10-lite-8gb-ram-128gb-rom-4500-mah-battery-prism-white-i136130385-s1296426893.html?spm=a2a0e.searchlist.list.1.50bb5130LSO5Iz&search=1"},
                new Product{ProductId=3,Catagory="Shampoo",Price=123,Stock=13,StoreId=1,UserId= 1,Discount="10",Link="https://www.amazon.com/Samsung-Galaxy-S9-Display-Resistance/dp/B07WVRJQ7V/ref=sr_1_2?crid=2BXW75J7J6OU&dchild=1&keywords=samsung+s9&qid=1622466509&sprefix=samsung+s9%2Caps%2C445&sr=8-2"},
                new Product{ProductId=5,Catagory="Toothbrush",Price=123,Stock=35,StoreId=2, UserId=2,Discount="15", Link="https://www.amazon.com/Asus-Phoenix-PH-GTX1060-3G-GeForce-Graphic/dp/B07VVMGP4G/ref=sr_1_10?dchild=1&keywords=gtx+1060&qid=1622466554&sr=8-10"},
                new Product{ProductId=6,Catagory="Laptop",Price=123,Stock=35,StoreId=2, UserId=2,Discount="5",Link="https://www.amazon.com/ASUS-Geforce-Phoenix-Graphics-PH-GTX1050TI-4G/dp/B01M360WG6/ref=sr_1_1?dchild=1&keywords=gtx+1050ti&qid=1622530878&sr=8-1"},
                new Product{ProductId=4,Catagory="Shampoo",Price=123,Stock=35,StoreId=3, UserId=3,Discount="7",Link="https://www.amazon.com/PlayStation-Console-Light-System-Greatest-4/dp/B077QT6K94/ref=sr_1_2?dchild=1&keywords=ps4&qid=1622530950&sr=8-2"}
